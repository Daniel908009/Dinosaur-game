...
def reset(place_of_call):
    ...
    settings_button = pygame.image.load(os.path.join(base_path, 'main_assets/settings.png'))
    resized_settings_button = pygame.transform.scale(settings_button, (base_size, base_size))
    settings_button_night = pygame.image.load(os.path.join(base_path, 'main_assets/settings_night.png'))
    ...
    touchdown = mixer.Sound(os.path.join(base_path, "sounds/energy_sound.mp3"))
    game_over_sound = mixer.Sound(os.path.join(base_path, "sounds/game_over_sound.mp3"))
    hit_sound = mixer.Sound(os.path.join(base_path, "sounds/hit_sound.mp3"))
...
def fact_func():
    ...
    with open(os.path.join(base_path,"random info file.txt"), "r") as file:
...
def game_over_screen():
    ...
    try:
        with open(os.path.join(base_path,"scores.txt"), "a") as file:
...
def dev_mode_images_change():
    ...
    if dev_mode:
        ...
        dinosaur_day = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur1_dev.png'))
        dinosaur_day2 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur1_2_dev.png'))
        dinosaur_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur2_dev.png'))
        dinosaur_night2 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur2_2_dev.png'))
        dinosaur_day_ducked = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur1_ducked_dev.png'))
        dinosaur_night_ducked = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur2_ducked_dev.png'))
        dinosaur_day2_ducked = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur1_2_ducked_dev.png'))
        dinosaur_night2_ducked = pygame.image.load(os.path.join(base_path,'dev_mode_assets/dinosaur2_2_ducked_dev.png'))
        cactus1 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus1_dev.png'))
        cactus2 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus2_dev.png'))
        cactus3 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus3_dev.png'))
        cactus4 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus4_dev.png'))
        cactus5 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus5_dev.png'))
        cactus6 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus6_dev.png'))
        cactus7 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus7_dev.png'))
        cactus8 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus8_dev.png'))
        cactus9 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus9_dev.png'))
        cactus10 = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus10_dev.png'))
        cactus1_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus1_night_dev.png'))
        cactus2_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus2_night_dev.png'))
        cactus3_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus3_night_dev.png'))
        cactus4_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus4_night_dev.png'))
        cactus5_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus5_night_dev.png'))
        cactus6_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus6_night_dev.png'))
        cactus7_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus7_night_dev.png'))
        cactus8_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus8_night_dev.png'))
        cactus9_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus9_night_dev.png'))
        cactus10_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/cactus10_night_dev.png'))
        pterodactyl_day = pygame.image.load(os.path.join(base_path,'dev_mode_assets/pterodactyl_temporary_dev.png'))
        pterodactyl_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/pterodactyl_temporary2_dev.png'))
        powerup1_day = pygame.image.load(os.path.join(base_path,'dev_mode_assets/power_up1_day_dev.png'))
        powerup2_day = pygame.image.load(os.path.join(base_path,'dev_mode_assets/power_up2_day_dev.png'))
        powerup3_day = pygame.image.load(os.path.join(base_path,'dev_mode_assets/power_up3_day_dev.png'))
        powerup1_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/power_up1_night_dev.png'))
        powerup2_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/power_up2_night_dev.png'))
        powerup3_night = pygame.image.load(os.path.join(base_path,'dev_mode_assets/power_up3_night_dev.png'))
        ...
        dinosaur_day = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur1.png'))
        dinosaur_day2 = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur1_2.png'))
        dinosaur_night = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur2.png'))
        dinosaur_night2 = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur2_2.png'))
        dinosaur_day_ducked = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur1_ducked.png'))
        dinosaur_night_ducked = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur2_ducked.png'))
        dinosaur_day2_ducked = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur1_2_ducked.png'))
        dinosaur_night2_ducked = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur2_2_ducked.png'))
        cactus1 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus1.png'))
        cactus2 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus2.png'))
        cactus3 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus3.png'))
        cactus4 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus4.png'))
        cactus5 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus5.png'))
        cactus6 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus6.png'))
        cactus7 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus7.png'))
        cactus8 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus8.png'))
        cactus9 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus9.png'))
        cactus10 = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus10.png'))
        cactus1_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus1_night.png'))
        cactus2_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus2_night.png'))
        cactus3_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus3_night.png'))
        cactus4_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus4_night.png'))
        cactus5_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus5_night.png'))
        cactus6_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus6_night.png'))
        cactus7_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus7_night.png'))
        cactus8_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus8_night.png'))
        cactus9_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus9_night.png'))
        cactus10_night = pygame.image.load(os.path.join(base_path,'main_cactuses/cactus10_night.png'))
        powerup1_day = pygame.image.load(os.path.join(base_path,'powerups/power_up1_day.png'))
        powerup2_day = pygame.image.load(os.path.join(base_path,'powerups/power_up2_day.png'))
        powerup3_day = pygame.image.load(os.path.join(base_path,'powerups/power_up3_day.png'))
        powerup1_night = pygame.image.load(os.path.join(base_path,'powerups/power_up1_night.png'))
        powerup2_night = pygame.image.load(os.path.join(base_path,'powerups/power_up2_night.png'))
        powerup3_night = pygame.image.load(os.path.join(base_path,'powerups/power_up3_night.png'))
        powerup4_day = pygame.image.load(os.path.join(base_path,'powerups/powerup4.png'))
        powerup4_night = pygame.image.load(os.path.join(base_path,'powerups/powerup4_night.png'))
        # the pterodactyls were supposed to be temporary, but I now think they fit quite well, so I will keep them
        pterodactyl_day = pygame.image.load(os.path.join(base_path,'main_assets/pterodactyl_temporary.png'))
        pterodactyl_night = pygame.image.load(os.path.join(base_path,'main_assets/pterodactyl_temporary2.png'))
    # resizing the images
...
def apply_settings(window, setting1, setting2, setting3, setting4, setting5, setting6, setting7, setting8, setting9, setting10, setting11, setting12, setting13, background_music_loudness, sound_loudness, setting14):
    ...
    if setting14 == "country":
        selected_music = os.path.join(base_path,"sounds/background.mp3")
    elif setting14 == "rock":
        selected_music = os.path.join(base_path,"sounds/rock_question_mark.mp3")
    elif setting14 == "opera":
        selected_music = os.path.join(base_path,"sounds/opera.mp3")
    elif setting14 == "techno":
        selected_music = os.path.join(base_path,"sounds/techno.mp3")
...
def settings_window():
    ...
    window.iconbitmap(os.path.join(base_path,"main_assets/setting.ico"))
    ...
    if selected_music == os.path.join(base_path,"sounds/background.mp3"):
        e14.set("country")
    elif selected_music == os.path.join(base_path,"sounds/rock_question_mark.mp3"):
        e14.set("rock")
    elif selected_music == os.path.join(base_path,"sounds/opera.mp3"):
        e14.set("opera")
    elif selected_music == os.path.join(base_path,"sounds/techno.mp3"):
        e14.set("techno")
...
icon = pygame.image.load(os.path.join(base_path,'main_assets/dinosaur1.png'))
...
mixer.music.load(os.path.join(base_path,"sounds/main_menu_music.mp3"))
mixer.music.set_volume(current_background_music_loudness/100)
selected_music = os.path.join(base_path,"sounds/background.mp3")
background_music_on = True
background_music_playing = False
...
play_button = pygame.image.load(os.path.join(base_path,'main_assets/play_button.png'))
resized_play_button = pygame.transform.scale(play_button, (base_size*5, base_size*2))
exit_button = pygame.image.load((os.path.join(base_path,'main_assets/exit_button.png')))
resized_exit_button = pygame.transform.scale(exit_button, (base_size*5, base_size*2))
scores_button = pygame.image.load((os.path.join(base_path,'main_assets/scores_button.png')))
resized_scores_button = pygame.transform.scale(scores_button, (base_size*5, base_size*2))
back_arrow = pygame.image.load((os.path.join(base_path,'main_assets/back_arrow.png')))
resized_back_arrow = pygame.transform.scale(back_arrow, (base_size*2, base_size*2))

# images used in the background
backgrounddino1 = pygame.image.load((os.path.join(base_path,'background_images/background_dinosaur1.png')))
backgrounddino1_night = pygame.image.load((os.path.join(base_path,'background_images/background_dinosaur1_night.png')))
backgroundegg = pygame.image.load((os.path.join(base_path,'background_images/egg.png')))
backgroundegg_night = pygame.image.load((os.path.join(base_path,'background_images/egg_night.png')))
backgroundcrater1 = pygame.image.load((os.path.join(base_path,'background_images/crater1.png')))
backgroundcrater1_night = pygame.image.load((os.path.join(base_path,'background_images/crater1_night.png')))
backgroundcrater2 = pygame.image.load((os.path.join(base_path,'background_images/crater2.png')))
backgroundcrater2_night = pygame.image.load((os.path.join(base_path,'background_images/crater2_night.png')))
backgroundcrater3 = pygame.image.load((os.path.join(base_path,'background_images/crater3.png')))
backgroundcrater3_night = pygame.image.load((os.path.join(base_path,'background_images/crater3_night.png')))
backgroundcrater4 = pygame.image.load((os.path.join(base_path,'background_images/crater4.png')))
backgroundcrater4_night = pygame.image.load((os.path.join(base_path,'background_images/crater4_night.png')))
tumble = pygame.image.load((os.path.join(base_path,'background_images/tumble1.png')))
tumble_night = pygame.image.load((os.path.join(base_path,'background_images/tumble1_night.png')))
dinosaur_skull = pygame.image.load((os.path.join(base_path,'background_images/dinosaur_skull.png')))
dinosaur_skull_night = pygame.image.load((os.path.join(base_path,'background_images/dinosaur_skull_night.png')))
footprint = pygame.image.load((os.path.join(base_path,'background_images/footprint.png')))
footprint_night = pygame.image.load((os.path.join(base_path,'background_images/footprint_night.png')))
footprint_rock = pygame.image.load((os.path.join(base_path,'background_images/footprint_rock.png')))
footprint_rock_night = pygame.image.load((os.path.join(base_path,'background_images/footprint_rock_night.png')))
raptor = pygame.image.load((os.path.join(base_path,'background_images/raptor.png')))
raptor_night = pygame.image.load((os.path.join(base_path,'background_images/raptor_night.png')))
runner = pygame.image.load((os.path.join(base_path,'background_images/runner.png')))
runner_night = pygame.image.load((os.path.join(base_path,'background_images/runner_night.png')))
stegosaurus = pygame.image.load((os.path.join(base_path,'background_images/stegosaurus.png')))
stegosaurus_night = pygame.image.load((os.path.join(base_path,'background_images/stegosaurus_night.png')))
triceratops = pygame.image.load((os.path.join(base_path,'background_images/triceratops.png')))
triceratops_night = pygame.image.load((os.path.join(base_path,'background_images/triceratops_night.png')))
...
# clouds images
cloud1_day = pygame.image.load(os.path.join(base_path,'sky_images/cloud1_day.png'))
cloud2_day = pygame.image.load(os.path.join(base_path,'sky_images/cloud2_day.png'))
cloud1_night = pygame.image.load(os.path.join(base_path,'sky_images/cloud1_night.png'))
cloud2_night = pygame.image.load(os.path.join(base_path,'sky_images/cloud2_night.png'))
cloud3_day = pygame.image.load(os.path.join(base_path,'sky_images/cloud3_day.png'))
cloud3_night = pygame.image.load(os.path.join(base_path,'sky_images/cloud3_night.png'))
cloud4_day = pygame.image.load(os.path.join(base_path,'sky_images/cloud4_day.png'))
cloud4_night = pygame.image.load(os.path.join(base_path,'sky_images/cloud4_night.png'))
...
lucky_comet_night = pygame.image.load(os.path.join(base_path,'sky_images/falling_star.png'))
lucky_comet_day = pygame.image.load(os.path.join(base_path,'sky_images/falling_star_day.png'))
lucky_comets = pygame.sprite.Group()

# asteroid images
asteroid = pygame.image.load(os.path.join(base_path,'sky_images/asteroid.png'))
asteroid1 = pygame.image.load(os.path.join(base_path,'sky_images/asteroid2.png'))
asteroid2 = pygame.image.load(os.path.join(base_path,'sky_images/asteroid3.png'))
asteroid3 = pygame.image.load(os.path.join(base_path,'sky_images/asteroid4.png'))
...
sun = pygame.image.load(os.path.join(base_path,'sky_images/sun.png'))
moon = pygame.image.load(os.path.join(base_path,'sky_images/moon.png'))
...
settings_button_night = pygame.image.load(os.path.join(base_path,'main_assets/settings_night.png'))
resized_settings_button_night = pygame.transform.scale(settings_button_night, (base_size, base_size))
home_button = pygame.image.load(os.path.join(base_path,'main_assets/home_button.png'))
resized_home_button = pygame.transform.scale(home_button, (base_size, base_size))
home_button_night = pygame.image.load(os.path.join(base_path,'main_assets/home_button_night.png'))
resized_home_button_night = pygame.transform.scale(home_button_night, (base_size, base_size))
...
powerup_picked_up = pygame.mixer.Sound(os.path.join(base_path,"sounds/powerup_pickedup.mp3"))
...
fact_buble = pygame.image.load(os.path.join(base_path,"main_assets/fact_buble.png"))
fact_buble_night = pygame.image.load(os.path.join(base_path,"main_assets/fact_buble_night.png"))
